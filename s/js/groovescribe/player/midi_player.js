    ...
    callback(data) {
        ...
        if (data.message == 144) {
            ...
            if (note_type) {
                ...
                if (options.highlightOn) highlightNoteInABCSVGFromPercentComplete(editor.track.trackID, editor.track.note_mapping_array, percentComplete, editor.track.numberOfMeasures, editor.track.repeatedMeasures);
