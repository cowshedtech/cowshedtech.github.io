/** Inline metronome icon SVG for the MIDI player controls template. */
export function addInlineMetronomeSVG() {
...
if (typeof window !== 'undefined') {
  window.addInlineMetronomeSVG = addInlineMetronomeSVG;
}
