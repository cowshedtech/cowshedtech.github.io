...
export default {
  ...
  computed: {
    noteABC() {
      ...
      return this.track ? this.track.getInstrumentNote(Instruments.SNARE, this.noteIndex) : constant_ABC_OFF;
    },
    noteConfig() {
      return {
        [constant_ABC_OFF]: { 
  ...
  methods: {
    handleLeftClick(event) {
        ...
        this.track.setInstrumentNote(Instruments.SNARE, this.noteIndex, newMode);        
    },
    ...
    handleMouseEnter(event) {
      ...
      if (action)
        this.track.setInstrumentNote(Instruments.SNARE, this.noteIndex, action == "off" ? constant_ABC_OFF : constant_ABC_SN_Accent);    
    },
    handleAction(action) {
      this.track.setInstrumentNote(Instruments.SNARE, this.noteIndex, action);  
      if (this.midiPlayer) {
