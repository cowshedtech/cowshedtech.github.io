...
export default {
  ...
  computed: {
    ...
    noteABC() {
      // depend on version so in-place mutations trigger recompute
        ...
        this.track && this.track.version;
        return this.track ? this.track.getInstrumentNote(Instruments.HIGH_HAT, this.noteIndex) : constant_ABC_OFF;
      }    
  },
  ...
  methods: {
    handleLeftClick(event) {
        ...
        this.track.setInstrumentNote(Instruments.HIGH_HAT, this.noteIndex, newMode);  
    },
    ...
    handleMouseEnter(event) {
        ...
        if (action)
          this.track.setInstrumentNote(Instruments.HIGH_HAT, this.noteIndex, action == "off" ? constant_ABC_OFF : constant_ABC_HH_Normal);          
    },
    handleAction(action) {
      if (this.midiPlayer) {
      ...
      this.track.setInstrumentNote(Instruments.HIGH_HAT, this.noteIndex, action);  
