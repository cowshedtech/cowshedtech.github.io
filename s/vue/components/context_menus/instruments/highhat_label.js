  ...
  template: `
	<div class="noteContextMenu">
		<ul id="hhLabelContextMenu" class="list">
			...
			<li onclick='noteLabelPopupClick("hh", "downbeats");'>downbeats</li>
			<li onclick='noteLabelPopupClick("hh", "upbeats");'>upbeats</li>
			<li id='mute_hh_menu_item' onclick='noteLabelPopupClick("hh", "mute");'>mute HH sound</li>
